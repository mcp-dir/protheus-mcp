...
TOTVS Protheus segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **TOTVS** | BR | Fornecedor do ERP (o servidor Protheus é do próprio cliente) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [protheus@mcp.ai](mailto:protheus@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
